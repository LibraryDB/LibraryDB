...
public class LibraryDB implements ActionListener
{
	...
	private void initTableValues(){
		...
		try {
			...
			manager.insertBorrowing(new Borrowing("a1","c","QA1",1,"2013/01/01",null));
			manager.insertBorrowing(new Borrowing("a2","c","QA1",2,"2013/03/19",null));
			manager.insertBorrowing(new Borrowing("a3","c","QA1",3,"2013/03/19","in"));
			manager.insertBorrowing(new Borrowing("a4","c","QA1",4,"2013/03/01",null));
			manager.insertBorrowing(new Borrowing("a5","c","QA1",5,"2013/03/02",null));
